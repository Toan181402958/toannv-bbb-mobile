  ...
  reducers: {
    ...
    editStreamExternalVideoMeeting: (state, action) => {
      ...
      state.streamExternalVideoMeeting[streamExternalVideoMeetingObject.id] = {
        ...state.streamExternalVideoMeeting[
          streamExternalVideoMeetingObject.id
        ],
    ...
    cleanupStaleData: (state, action) => {
      ...
      if (state?.externalVideoMeetingsCollection) {
        Object.entries(state?.externalVideoMeetingsCollection).forEach(
          ([id, document]) => {
...
// Selectors
const selectCurrentExternalVideo = (state) =>
  Object.values(
...
export { selectCurrentExternalVideo };
